...
In order to choose which file to test, modify the line

    24. mode = 'static'; fileNum = 3; n = 12; 

If mode = 'static', then it will use the static file directory. fileNum specifies which file to use (i.e. 3 uses '3.wav'). If running on a dynamic file, modify the value of n to specify which window into the file you wish to test. n = 1 will do a window from 0-0.5s, n = 15 will do a window from 3.5-4s into the clip.